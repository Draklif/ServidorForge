...
## Instalación
1. Descargar e instalar Neoforge, teniendo cuidado de seleccionar la versión correspondiente según se indica al inicio de este archivo. 
...
3. Descargar del apartado de releases el mod Cobblemon.jar y añadir a la carpeta de mods.
