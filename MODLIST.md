...
* Dragon Mounts v1.2.3
* Dustrial Decor v1.3.5
* Easy Anvils v8.0.2
* Eidolon Repraised v0.3.8.13
* Elenai Dodge v1.1
* Elytra Slot v6.4.4
* Emotecraft v2.2.7
* Ender Mail v1.2.9
...
* Immersive Aircraft v1.1.2
* Incendium v5.3.5
* Infinite Trading v4.5
* Iron Chest v14.4.4
* Iron's Spells 'n Spellbooks v3.4.0.2
...
* Let's Do Nether Vinery v1.2.14
* Let's Do Vinery v1.4.28
* Log Begone v1.0.8
...
* Not Enough Animations v1.7.6
* Oculus v1.7.0
* Offline Skins v1
* Overloaded Armor Bar v1
* Reblured v1.3.0
* Shulker Box Tooltip v4.0.4
* Skin Layers 3D v1.6.7
* Sound Physics v1.4.5
* Visuality v2.0.2
